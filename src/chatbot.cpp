...
ChatBot::ChatBot(const ChatBot &otherchatbot) {
  std::cout << "Copy Constructor Chatbot from = " << &otherchatbot
            << " to = " << this << std::endl;
...
ChatBot &ChatBot::operator=(const ChatBot &otherchatbot) {
  ...
  std::cout << "Copy Constructor assignement Chatbot from = " << &otherchatbot
            << " to = " << this << std::endl;
  if (this == &otherchatbot) {
    return *this;
  }
  _image = new wxBitmap(*(otherchatbot._image));
  _currentNode = otherchatbot._currentNode;
...
ChatBot::ChatBot(ChatBot &&otherchatbot) {
  std::cout << "Move Constructor Chatbot from = " << &otherchatbot
            << " to = " << this << std::endl;
...
ChatBot &ChatBot::operator=(ChatBot &&otherchatbot) {
  std::cout << "Move Constructor assignement  Chatbot from = " << &otherchatbot
            << " to = " << this << std::endl;
  if (this == &otherchatbot) {
    return *this;
  }
