...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename) {
  ...
  ChatBot chatbothandle("../images/chatbot.png");

  // set this as intial chat bot handle
  SetChatbotHandle(&chatbothandle);

  // add pointer to chatlogic so that chatbot answers can be passed on to the
  // GUI
  chatbothandle.SetChatLogicHandle(this);
  // add chatbot to graph root node
  chatbothandle.SetRootNode(rootNode);

  // move ownership of chatbot handle to rootnode
